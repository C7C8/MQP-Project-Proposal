...
\begin{code}[h]
    \inputcpp{text/caida/code/save_to_db.cpp}
...
After all filtering and aggregating was complete, there were \textapprox230 million data points.
