...
\begin{wrapfigure}[18]{R}{0.55\textwidth}
    \centering
    \includegraphics[width=0.55\textwidth]{caida/rtt_distribution.png}
...
\begin{wrapfigure}[18]{L}{0.55\textwidth}
    \centering
    \includegraphics[width=0.55\textwidth]{caida/rtt_distribution_indirect.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{caida/measurements_distribution.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{caida/rtt_stdev_distribution.png}
...
Since standard deviations are all relative, we next calculated a \cv for each \ip address pair as a measurement of data quality. \Cref{fig:caida_cv_distribution} shows the distribution of \cvs for all \ip address pairs, with the majority of \cvs below 0.1 -- in other words, very good data with low spread for each pair.

\begin{figure}[h]
    \centering
    \includegraphics{caida/rtt_cv_distribution.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{caida/ms_per_km_distribution.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{caida/frac_c_efficiency_distribution.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{caida/scatterplot.png}
...
\begin{figure}[h]
    \centering
    \includegraphics{caida/speed_of_light_idw.jpg}
