...
To measure internet connectivity from a users browser we had to to develop ways to collect data, and different ways to distribute it.\todo{Revise this to be more informative}
